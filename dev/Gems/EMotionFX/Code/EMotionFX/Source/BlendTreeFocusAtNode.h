...
namespace EMotionFX
{
     ...
     *
     */
    class EMFX_API BlendTreeFocusAtNode
        : public AnimGraphNode
    {
        MCORE_MEMORYOBJECTCATEGORY(BlendTreeFocusAtNode, EMFX_DEFAULT_ALIGNMENT, EMFX_MEMCATEGORY_ANIMGRAPH_BLENDTREENODES);

    public:
        AZ_RTTI(BlendTreeFocusAtNode, "{39673AB4-5f6f-47B6-B977-9Df5A28AA063}", AnimGraphNode);
        ...
        enum
        {
            ...
            ATTRIB_CHAIN_LENGTH,                // the node to apply the lookat on, for example the head
        ...
        static BlendTreeFocusAtNode* Create(AnimGraph* animGraph);
    ...
    private:
        BlendTreeFocusAtNode(AnimGraph* animGraph);
        ~BlendTreeFocusAtNode();
